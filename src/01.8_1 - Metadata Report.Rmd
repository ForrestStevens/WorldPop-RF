...
```{r predict_density, echo=FALSE, fig.height=10, fig.width=10, out.width="720px", out.height="720px", cache=TRUE}
z.lim = c(0,max_pop)
...
```{r census_data, echo=FALSE, comment="", results='asis', fig.width=10, fig.height=10, out.width="720px", out.height="720px", cache=TRUE}
...
```{r random_forest, echo=FALSE, comment="", fig.width=10, fig.height=10, out.width="720px", out.height="720px", cache=TRUE}
...
Covariate Metadata
--------------------------------------------------------
```{r covariate_reports, echo=FALSE, comment="", results='asis', fig.width=10, fig.height=10, out.width="720px", out.height="720px", cache=TRUE}
...
for (i in names(metadata)[names(metadata) != "Census"]) {
	...
	if (metadata[[i]]$dataset_class == "raster") {
		...
		dataset <- raster( metadata[[i]]$path )
